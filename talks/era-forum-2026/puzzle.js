...
(function () {
  ...
  function build(host, opts = {}) {
    ...
    const svg = el("svg", {
      ...
      width: "100%",
      height: "100%",
      style: "display: block; font-family: system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif; touch-action: manipulation;",
    });
    ...
    const CLUSTER_COLORS = {
      "-1": { fill: "rgba(100,116,139,0.05)", stroke: "rgba(100,116,139,0.13)" },
      "0":  { fill: "rgba(37,99,235,0.05)",   stroke: "rgba(37,99,235,0.13)"   },
      "1":  { fill: "rgba(13,148,136,0.05)",  stroke: "rgba(13,148,136,0.13)"  },
      "2":  { fill: "rgba(99,102,241,0.06)",  stroke: "rgba(99,102,241,0.13)"  },
    };
    const LANE_PAD_X = 32;
    const LANE_PAD_Y = 18;
    ...
    PIECES.forEach((p) => {
      ...
      const tag = el("text", {
        ...
        fill: p.cluster === "authors" ? "rgba(71,85,105,0.95)" : "rgba(26,36,51,0.74)",
      });
      ...
      lines.forEach((line, i) => {
        const t = el("text", {
          ...
          "font-size": "23",
          "font-weight": "600",
          fill: p.cluster === "authors" ? "#334155" : "#141b27",
      ...
      const role = el("text", {
        ...
        "font-family": "ui-monospace, 'SF Mono', SFMono-Regular, Menlo, Consolas, monospace",
        "font-size": "11",
        fill: p.cluster === "authors" ? "rgba(71,85,105,0.95)" : "rgba(26,36,51,0.82)",
    ...
    CONNECTIONS.forEach((c) => {
      ...
      const ribbon = el("rect", {
        ...
        fill: "#eef4ff", stroke: "#2780e3", "stroke-width": "1",
        filter: "url(#noteShadow)",
      });
      wrap.appendChild(ribbon);

      [-rw / 2 + 8, rw / 2 - 8].forEach((dx) => {
        wrap.appendChild(el("circle", { cx: dx, cy: 0, r: 2, fill: "#2780e3", opacity: "0.7" }));
      });
      ...
      const label = el("text", {
        ...
        fill: "#2780e3", "letter-spacing": "0.1em",
      });
    ...
    POLICIES.forEach((pol) => {
      ...
      const note = el("rect", {
        x: -noteW / 2, y: -noteH / 2, width: noteW, height: noteH, rx: 8,
        fill: "#e8f1fc", stroke: "#2780e3", "stroke-width": "1.6",
        filter: "url(#noteShadow)",
      });
      wrap.appendChild(note);
      const pin = el("circle", { cx: -noteW / 2 + 18, cy: -noteH / 2 + 16, r: 7, fill: "#2780e3", stroke: "#1c64c4" });
      wrap.appendChild(pin);
      wrap.appendChild(el("circle", { cx: -noteW / 2 + 16, cy: -noteH / 2 + 14, r: 2, fill: "#ffffff", opacity: "0.8" }));
      ...
      titleLines.forEach((line, idx) => {
        const t = el("text", {
          ...
          "font-family": "system-ui, -apple-system, 'Segoe UI', Roboto, sans-serif", "font-size": "17", "font-weight": "600",
          fill: "#1a2433",
        });
        t.textContent = line;
        wrap.appendChild(t);
      ...
      const authors = el("text", {
        ...
        "font-family": "ui-monospace, 'SF Mono', SFMono-Regular, Menlo, Consolas, monospace",
        "font-size": "9", fill: "rgba(26,36,51,0.55)", "letter-spacing": "0.04em",
      });
    ...
    function highlightPiece(id, on) {
      ...
      const baseWidth = "1.3";
      const baseStroke = piece && piece.cluster === "authors" ? "rgba(71,85,105,0.45)" :
                         "rgba(26,36,51,0.16)";
